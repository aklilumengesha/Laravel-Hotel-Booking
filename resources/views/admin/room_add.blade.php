                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="number" class="form-control" name="total_beds" value="{{ old('total_beds') }}" min="1">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Total Bathrooms *</label>
                                    <input type="number" class="form-control" name="total_bathrooms" value="{{ old('total_bathrooms') }}" min="1">
                                </div>
